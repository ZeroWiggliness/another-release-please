/**
 * Helm package manifest processor
 * Handles versioning for Helm charts
 */
...
/**
 * Helm package manifest processor
 * Default target file: Chart.yaml under the manifest path
 */
export class HelmPackageManifest extends PackageManifest {
  ...
  private defaultFiles(): ManifestFile[] {
    ...
    const chartPath = dir ? `${dir}/**/Chart.yaml` : '**/Chart.yaml';
    return [
      {
        path: chartPath,
        filetype: 'yaml',
